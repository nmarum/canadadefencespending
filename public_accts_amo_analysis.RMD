...
amo_analysis %>%
  filter(OBJ_EN_NM %in% c("Aircraft", "Munitions, and ammunition"),
         FSCL_YR %in% c("2015/2016", "2016/2017", "2017/2018", "2018/2019", "2019/2020")) %>%
  ggplot (aes(x=FSCL_YR, y=AGRG_PYMT_AMT, col= OBJ_EN_NM,
