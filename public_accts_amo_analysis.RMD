...
```{r echo=FALSE, message=FALSE, warning=FALSE}
amo_analysis |>
  filter(!FSCL_YR %in% c("2009/2010", "2010/2011", "2011/2012"), OBJ_EN_NM == "Aircraft parts") |>
  group_by(FSCL_YR) |>
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
amo_analysis |>
  filter(OBJ_EN_NM %in% c("Aircraft parts", "Aircraft"), !FSCL_YR %in% c("2009/2010", "2010/2011", "2011/2012", "2012/2013")) |>
