...
Over the past several years as we have entered farther into the era of "Big Data", governments around the world have moved to make their data more accessible to the public.  This movement towards "open data" is part of a increasingly common government policy of openness as a demonstration of transparency to citizens, support economic growth, and provide better services.  The Government of Canada is no exception to this trend having launched a number of initaitives to make government data more accessible.  
...
The type of defence spending information available includes high level information regarding defence expenditures such as  Parliament-approved appropriations and actual expenditures by fiscal year or actual expenditures by "standard object" (i.e., broad categories of government expenditures such as expenditures on personnel salaries, travel expenses, equipment, etc.).  There is also incredibly granualar information regarding the award of military contracts of all sizes, however with some data integrity issues (e.g., coding and data entry errors).  

While these are helpful resources to shed light on military spending and procurement, each requires a relatively deep understanidng of government expenditure and contracting processes to be able to fully understand its potential and recognize its limitations.  For example, information on contract award does not provide detail as to if or when expenditures were made against those contracts for the receipt of goods/services or, for large projects, the achievement of milestones.  Also having information on expenditures by parliamentary "vote" or "standard object" provides too high level information to explore targetted questions of interest due to the inability to clearly link expenditures to procurement projects.  This is key as government expenditures in Canada, under the _Financial Administration Act_, are made upon receipt of goods or when a contractor hits a contract milestone with very few exceptions.  For a reseracher or analyst intersted in understanding how Canada is investing in its military, understanding where and when actual expenditures for military "capability" (e.g., military equipment or infrastructure) is crucial.
