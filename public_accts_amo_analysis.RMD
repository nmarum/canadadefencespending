...
subtitle: "Analysis of National Defence expenditures for the acquisition of equipment and machinery from Canada's Public Accounts (2010 to 2021)"
author:
date: "April 2022"
output:
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
amo_analysis %>% filter(!FSCL_YR %in% c("2009/2010", "2010/2011"), OBJ_EN_NM == "Aircraft parts") %>%
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
amo_analysis %>% filter(OBJ_EN_NM %in% c("Aircraft parts", "Aircraft"), !FSCL_YR %in% c("2009/2010", "2010/2011")) %>%
