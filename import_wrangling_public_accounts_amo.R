...
amo_2010to2019 <- bind_rows(amo_dnd_2010, amo_dnd_2011)
amo_2010to2019 <- bind_rows(amo_2010to2019, amo_dnd_2012)
amo_2010to2019 <- bind_rows(amo_2010to2019, amo_dnd_2013)
amo_2010to2019 <- bind_rows(amo_2010to2019, amo_dnd_2014)
amo_2010to2019 <- bind_rows(amo_2010to2019, amo_dnd_2015)
amo_2010to2019 <- bind_rows(amo_2010to2019, amo_dnd_2016)
amo_2010to2019 <- bind_rows(amo_2010to2019, amo_dnd_2017)
amo_2010to2019 <- bind_rows(amo_2010to2019, amo_dnd_2018)
amo_2010to2019 <- bind_rows(amo_2010to2019, amo_dnd_2019)

save(amo_2010to2019, file = "amo_2010to2019.rda")#create RDA file containing the data
file.exists("amo_2010to2019.rda") #check to make sure it was successful
view(amo_2010to2019)

file.remove(c("amo_2019.csv", "amo_2018.csv", "amo_2017.csv", "amo_2016.csv", "amo_2015.csv", "amo_2014.csv", "amo_2013.csv", "amo_2012.csv", "amo_2011.csv", "amo_2010.csv"))
#clean up complete!